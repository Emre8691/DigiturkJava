...
XCOPY C:\Users\fakioglu\Documents\BSH\webtests\webtests\target\jbehave\* /i /y
cd  C:\Users\fakioglu\Documents\BSH\webtests\webtests\

SET SYSTEM=futureint
SET SERVER=noserver

SET STORYPATH=jbehave.story.path.pattern=migration/TTP-482.story

SET SELENIUM=selenium.url=http://localhost:7777/wd/hub
