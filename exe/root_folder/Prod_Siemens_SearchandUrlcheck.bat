SET SYSTEM=production
SET SERVER=noserver

SET STORYPATH=jbehave.story.path.pattern=production/basics/search_no_shop/**.story
SET SELENIUM=selenium.url=http://localhost:4444/wd/hub
...
echo.
echo ---------------------------------------
CALL C:\BSHWebTests\Maven\bin\mvn clean integration-test -X -D%TESTEDSYSTEM% -D%METAFILTER% -D%STORYPATH% -D%SELENIUM% -D%BROWSERPATH%
echo SCRIPT DONE
