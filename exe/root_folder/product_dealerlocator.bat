...
SET STORYPATH=jbehave.story.path.pattern=product/dealer_locator/**.story
SET SELENIUM=selenium.url=http://localhost:4448/wd/hub


@REM --  SET BROWSERPATH=selenium.browser.path=C:/Users/fakioglu/Documents/Ufuk/FirefoxPortable_29/App/Firefox/firefox.exe
...
echo.
echo ---------------------------------------
@REM --  START CMD /k "C:\BSHWebTests\Maven\bin\mvn antrun:run -Duse-firefox-portable=true"
@REM --  DISPLAY=localhost:99.0
@REM -- START CMD /k "CALL C:\BSHWebTests\Maven\bin\mvn integration-test -D%TESTEDSYSTEM% -D%METAFILTER% -D%STORYPATH%"
