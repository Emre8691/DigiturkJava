...
@import url( "../../view/style/jbehave-core.css" );
</style>
</head>

<body>
<div id="banner"><img src="../../view/images/jbehave-logo.png" alt="jbehave" />
<div class="clear"></div>
</div>

<div class="reports">

<h2>Story Reports3</h2>
...
<td class="${storyClass}">
	<table>
		...
		<tr><td>${storyDescriptions.get(report.name)}</td></tr>
	</table>
</td>
<td>
