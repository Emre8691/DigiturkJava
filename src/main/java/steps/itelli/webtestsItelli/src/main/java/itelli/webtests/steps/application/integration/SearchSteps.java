package steps.itelli.webtestsItelli.src.main.java.itelli.webtests.steps.application.integration;
 ...
 * @param <ContextBase>
 */
public class SearchSteps<ContextBase> extends AbstractSteps<ContextBase> {
